        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Brand_Logo = table.Column<string>(type: "nvarchar(max)", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Cars_Brands", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Model_Icon = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    CarBrand_Id = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Car_Models", x => x.Id);
                    table.ForeignKey(
                        name: "FK_Car_Models_Cars_Brands_CarBrand_Id",
                        column: x => x.CarBrand_Id,
                        principalTable: "Cars_Brands",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.NoAction);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Made_Year = table.Column<int>(type: "int", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Cars_AspNetUsers_User_Id",
                        column: x => x.User_Id,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.NoAction);
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.NoAction);
                    table.ForeignKey(
                        name: "FK_Cars_Cars_Brands_Car_Brand_Id",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Cars_Images", x => x.ID);
                    table.ForeignKey(
                        name: "FK_Cars_Images_Cars_Car_Id",
                        column: x => x.Car_Id,
                        principalTable: "Cars",
                        principalColumn: "ID",
                        onDelete: ReferentialAction.NoAction);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Car_Models_CarBrand_Id",
                table: "Car_Models",
                column: "CarBrand_Id");
